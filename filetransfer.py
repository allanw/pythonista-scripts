...
class TransferRequestHandler(BaseHTTPRequestHandler):
	...
	def do_GET(self):
		...
		if path == '/':
			...
			self.end_headers()
			self.wfile.write('{"audio-file-3.mp3": {"url": "http://10.0.0.30:8080/piano2-CoolEdit.mp3", "type": "mp3", "canSkip": true, "id": "ded84ffd4b8b47c9755652c2143c15cd", "name": "Als test"}}'.encode())
			return
...
if __name__ == '__main__':
	...
	server = HTTPServer(('10.0.0.30', 8080), TransferRequestHandler)
	URL = 'https://%s.:8080' % gethostname()
